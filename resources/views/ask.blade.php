    ...
    <div class="flex flex-col mt-8 h-screen">
        ...
        <div class="flex justify-center items-center gap-4 mb-4 px-6">
            ...
            <button onclick="startLoading()" 
                class="inline-block px-5 py-1.5 dark:text-[#EDEDEC] border-[#19140035] hover:border-[#fafaf94a] border text-[#1b1b18] dark:border-[#3E3E3A] dark:hover:border-[#62605b] rounded-sm text-sm leading-normal">
                再読み込み
            </button>
            <!-- 再度目標を設定ボタン -->
            <a href="/setting" 
        ...
        function startLoading() {
            ...
            leftContent.innerHTML = `
                <div class="flex flex-col items-center justify-center h-full">
                    ...
                    <p class="text-lg text-gray-600 dark:text-gray-300">タスク作成中...</p>
                </div>
            `;
